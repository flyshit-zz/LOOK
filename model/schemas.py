...
class  Attraction(BaseModel):
    ...
    location:Location=Field(...,description="经纬坐标")
    visit_duration:int=Field(...,description="建议游玩时间",ge=0)
    description: str = Field(...,description="景点描述")
    category:Optional[str]=Field(default="景点",description="景点类型")
